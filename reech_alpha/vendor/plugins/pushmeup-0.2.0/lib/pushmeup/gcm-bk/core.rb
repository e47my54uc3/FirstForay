...
module GCM
  ...
  def self.send_notification13213(device_tokens, data = {}, options = {})
    puts "In side send notification token is =#{device_tokens}"
    puts "In side send notification data is =#{data}"
    puts "In side send notification options is =#{options}"
