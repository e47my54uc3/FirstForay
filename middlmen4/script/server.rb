...
# Example : DAEMON_OPTS="-p 5000 -c /home/ubuntu/socialbeam/config/unicorn.rb -D"
DAEMON_OPTS=ENV["SOCIALBEAM_UNICORN_OPTS"].freeze
# Example for PID path PID='/home/ubuntu/socialbeam/shared/pids/unicorn.pid'
PID=ENV["SOCIALBEAM_UNICORN_PID"].freeze
#Example : SBCHAT_DAEMON_OPTS = "-s thin -E production"
SBCHAT_DAEMON_OPTS=ENV["SOCIALBEAM_FAYE_THIN_OPTS"].freeze
#Example for SBCHAT PID Path : SBCHAT_PID =  '/home/ubuntu/socialbeam/shared/pids/faye_thin.pid'
SBCHAT_PID=ENV["SOCIALBEAM_FAYE_THIN_PID"].freeze
	...
	class << self
		...
		def start_sbchat
			if !sbchat_pid?
				...
				system "bundle exec rackup #{APP_PATH}/socialbeam_chat.ru -D -P #{SBCHAT_PID} #{SBCHAT_DAEMON_OPTS}"
