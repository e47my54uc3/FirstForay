class User < ActiveRecord::Base
  ...
  # purchased solutions
	...
	has_many :scribble_comments, :through => :purchased_solutions
  ...
  #Profile
  has_one :user_profile,:primary_key=>:beamer_id,:foreign_key=>:beamer_id, :dependent => :destroy
  delegate :beamer_interests, :beamer_hobbies, :beamer_fav_music, :beamer_fav_movies, 
           :beamer_fav_books, :beamer_fav_sports, :beamer_fav_destinations,
           :beamer_fav_cuisines, :bio, :snippet,:beamer_interests=, :beamer_hobbies=, :beamer_fav_music=,
           :beamer_fav_movies=,:beamer_fav_books=, :beamer_fav_sports=, :beamer_fav_destinations=,
           :beamer_fav_cuisines=, :bio=, :snippet=,
           :to => :user_profile
           
  # Alias Profile of a beamer to be called User Profile or Beamer Profile
  alias_attribute :beamer_profile,:user_profile

  accepts_nested_attributes_for :user_profile

  after_create :create_beamer_profile
  ...
  # after_create callback to create new profile associated with the Beamer
  def create_beamer_profile
