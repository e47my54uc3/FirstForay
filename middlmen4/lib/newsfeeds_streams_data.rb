...
NEWSFEED_STREAM_ACCESSLOCATION = { 
    :public_location => 'Public Portion of MiddlMen',
    :private_location => 'Logged In Portion of MiddlMen, e.g Profile Page',
    :specific_location => 'Specific Portions of MiddlMen e.g Events or Group Page' }

# VERBS or ACTIVITIES
NEWSFEED_STREAM_VERBS = { 
    :new_user=> 'has joined MiddlMen!',
