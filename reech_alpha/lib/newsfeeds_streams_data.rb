...
# APPLICATION LEVEL CONSTANTS FOR REECH STREAM USAGE

#SCOPE of REECH STREAM
NEWSFEED_STREAM_ACCESSLOCATION = { 
    :public_location => 'Public Portion of Reech',
    :private_location => 'Logged In Portion of Reech, e.g Profile Page',
    :specific_location => 'Specific Portions of Reech e.g Events or Group Page' }

# VERBS or ACTIVITIES
NEWSFEED_STREAM_VERBS = { 
    :new_user=> 'has joined Reech!',
