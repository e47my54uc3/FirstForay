class ChatsController < ApplicationController
  ...
  def new_message
    ...
    if recipient = params[:message].match(/@(.+) (.+)/)
      ...
      @message = { :username => current_user.reecher_id, :msg => recipient.captures.second }
    else
      ...
      @message = { :username => "#{current_user.first_name}_#{current_user.reecher_id}", :msg => params[:message] }
    end
